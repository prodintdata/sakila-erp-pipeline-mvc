...
def print_descriptive_report(table_name, column_name, data, unit=""):
    """Formatea e imprime el reporte estadistico."""
    print(f"\n========================================================")
    ...
    print(f"--------------------------------------------------------")
    print(f"DETECTANDO OUTLIERS ")
    if outliers:
        print(f"Se detectaron {len(outliers)} valores atipicos unicos en BD:")
...
if __name__ == "__main__":
    ...
    if conn:
        try:
            ...
            # --------------------------------------------------------
            # ANÁLISIS 2: TABLA PAYMENT (AMOUNT)
            # --------------------------------------------------------
